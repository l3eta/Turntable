...
public class AFKExample extends Bot {
	...
	public AFKExample() {
		...
		getEventManager().registerListener(new AFKEvents(this));		
	}
	
	public class AFKEvents extends EventListener {
		private List<User> afks = new ArrayList<User>();
		private final int checkerWait = 60; //Time in seconds
		private RepeatingTask checker;
		
		public AFKEvents(Bot bot) {
			super(bot);
		}
