...
public class FramedataImpl1 implements FrameBuilder {
	...
	@Override
	public void append(Framedata nextframe) throws Exception {
	...
	public String toString() {
		return "Framedata{ optcode:" + getOpcode() + ", fin:" + isFin()
				+ ", masked:" + getTransfereMasked() + ", payloadlength:"
				+ unmaskedpayload.limit() + ", payload:"
				+ WebSocket.utf8Bytes(new String(unmaskedpayload.array()))
				+ "}";
	}
